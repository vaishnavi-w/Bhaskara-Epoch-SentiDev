...
Original file is located at
    https://colab.research.google.com/drive/1hkuHOUA6OGciXRGOzh8CZeVzeM8vgW--
"""
...
def sentiment_analysis_function(text):
    ...
    preprocessed_text = [preprocess_text(sentence) for sentence in text]
    ...
    # Print the preprocessed and padded sequences
...
def update_courses_and_insights(n_clicks, course_review, student_name, student_rating, student_comment):
    ...
    sentiment = sentiment_analysis_function(str(student_comment))
